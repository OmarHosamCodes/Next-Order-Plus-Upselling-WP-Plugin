...
class CartService {
    ...
    public function apply_cart_discount($cart) {
        ...
        WC()->session->set('b4g1f_total_savings', $discount);
    ...
    public function apply_discount_persistently($cart) {
        // Get stored discount
        $discount = WC()->session->get('b4g1f_total_savings', 0);
    ...
    public function save_discount_to_order($order, $data) {
        $discount_amount = WC()->session->get('b4g1f_total_savings', 0);
        ...
        if ($discount_amount > 0) {
            ...
            $order->update_meta_data('_b4g1f_discount_amount', $discount_amount);
        }
    }
